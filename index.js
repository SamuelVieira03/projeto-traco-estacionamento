...
//Spinner para mostrar o loading da página
const getSpinner = () => {
    const main = document.getElementById('root')
    const dadosHtml = `
...
//Puxar a ficha cadastral do HTML para o Javascript
...
//Puxar a lista de Clientes do HTML para o JavaScript
...
//Página de Checkin com as informações necessárias
...
// Página de checkout com informações e valores
...
//Faturamento e contabilização de carros
    ...
    //exportação dos conteudos para os outros modulos
 export const view = {
